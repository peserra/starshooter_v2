...
void BgModel::loadObj(std::string_view path, bool standardize) {
...
void BgModel::render(int numTriangles) const {
...
void BgModel::setupVAO(GLuint program) {
